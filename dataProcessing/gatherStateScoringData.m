function out = gatherStateScoringData(animID,sessionNum,varargin)
    ...
    nboot = 1000; % for bootstrapping band power to get mean and SEM
    specWinSize = 1; % seconds for binning CWT spectrogram
    specFreqRange = [0 30]; % Hz for CWT spec
    specFreqRes = 0.25; % Hz for CWT spec
